...
{
    public class VehicleBluredWheel_Editor : ShaderGUI
    {
        private const string ecsFolderGUID = "cc35dd109029b5b4fad9811ad43ccdf3";
        private static readonly string _logoImagePath = AssetDatabase.GUIDToAssetPath(ecsFolderGUID) + "/Editor/logoWheelBluring.png";
        MaterialProperty _WheelColor;
        MaterialProperty _WheelTexture;
        MaterialProperty _Transparency;
        MaterialProperty _BlurLevel;
        ...
        void GetValues()
        {
            _WheelColor = FindProperty("_WheelColor", materialProperties);
            _WheelTexture = FindProperty("_WheelTexture", materialProperties);
            _Transparency = FindProperty("_Transparency", materialProperties);
            _BlurLevel = FindProperty("_BlurLevel", materialProperties);
        ...
        void ShowProperties()
        {
            ...
            EditorGUILayout.Space();
            materialEditor.ShaderProperty(_WheelColor, "Wheel Color");
            materialEditor.ShaderProperty(_Transparency, "Blured Wheel Transparency");
            materialEditor.ShaderProperty(_BlurLevel, "Blur Level");
            materialEditor.TexturePropertySingleLine(new GUIContent("Blured Wheel Texture"), _WheelTexture);
            EditorGUILayout.Space();
