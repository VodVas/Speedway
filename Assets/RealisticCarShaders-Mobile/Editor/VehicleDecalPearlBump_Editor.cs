...
{
    public class VehicleDecalPearlBump_Editor : ShaderGUI
    {
        private const string ecsFolderGUID = "cc35dd109029b5b4fad9811ad43ccdf3";
        private static readonly string _logoImagePath = AssetDatabase.GUIDToAssetPath(ecsFolderGUID) + "/Editor/logoPearlBump.png";
        ...
        private bool firstApply = true,
            ReflectionUVFold, BodyUVFold, DecalsUVFold, PearlUVFold, DiffuseBump, PearlBump, DiffuseReflect;
