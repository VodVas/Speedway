...
{
    public class VehicleLight_Editor : ShaderGUI
    {
        private const string ecsFolderGUID = "cc35dd109029b5b4fad9811ad43ccdf3";
        private static readonly string _logoImagePath = AssetDatabase.GUIDToAssetPath(ecsFolderGUID) + "/Editor/logoLight.png";
        ...
        void GetValues()
        {
            ...
            _Emission = FindProperty("_Emission", materialProperties);
            // enum
        ...
        void ShowProperties()
        {
            ...
            materialEditor.ShaderProperty(_Color, "Light Color");
            materialEditor.ShaderProperty(_Transprnt, "Transparency");
            materialEditor.ShaderProperty(_Emission, "Light Emission");
