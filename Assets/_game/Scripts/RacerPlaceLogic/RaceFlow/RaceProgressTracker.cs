...
public class RaceProgressTracker : MonoBehaviour
{
    ...
    [SerializeField] private PlayerCarSelector _raceCarSelector = null;
...
//        bool lapCompleted;
//        _checkpointLogic.ProcessCheckpoint(
//            _checkpoints.Length,
//            racer,
//            checkpointIndex,
//            isPlayer,
...
//    {
//        if (newRacer == null) return;

//        int oldLength = (_racers == null) ? 0 : _racers.Length;
