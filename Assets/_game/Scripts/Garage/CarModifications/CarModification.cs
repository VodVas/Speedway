...
//        if (ModificationId < 0)
//        {
//            Debug.Log($"[CarModification] Неверный ModificationId: {ModificationId}", this);
//            enabled = false;
//            return;
//        }
...
//        {
//            Debug.Log($"[CarModification] Отрицательная цена {Price} у {ModificationName}", this);
//            enabled = false;
//            return;
//        }
...
//            {
//                Debug.Log($"[CarModification] TargetRenderer не назначен для модификации цвета!", this);
//                enabled = false;
//                return;
//            }
...
//            {
//                Debug.Log($"[CarModification] Не назначены материалы для модификации цвета!", this);
//                enabled = false;
//                return;
//            }
//        }
...
//        {
//            Debug.Log($"Material update failed: {exception.Message}");
//        }
//    }
