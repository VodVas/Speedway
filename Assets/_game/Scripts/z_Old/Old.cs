public class Old
{
    ...
    //    private void ProcessEpicCard(int index)
    //    {
    //        float roll = Random.value;
    ...
    //        {
    //            SpawnMoney(Rarity.Epic, index);
    //        }
    //        else
    //        {
    //            SpawnColor(Rarity.Epic, index);
    //        }
    //    }

    //    private void ProcessNonEpicCard(Rarity rarity, int index)
    //    {
    //        bool spawnMoney = Random.value < NON_EPIC_MONEY_CHANCE;

    //        if (spawnMoney)
    //        {
    //            SpawnMoney(rarity, index);
    //        }
    //        else
    //        {
    ...
    //    {
    //        PaintLootItem item = _PaintLootDatabase.GetRandomItem(rarity);
    ...
    //    private void SpawnMoney(Rarity rarity, int index)
    //    {
...
namespace YG
{
    ...
    public class SavesYG
    {
        ...
        private int _money = 300000;
        private int _lastUsedCarId = -1;
        private List<int> _purchasedCarIDs = new List<int>();
        private List<PurchasedUpgrade> _purchasedUpgrades = new List<PurchasedUpgrade>();
        private List<PurchasedModification> _purchasedModifications = new List<PurchasedModification>();
        private List<CarColorSave> _carColorSaves = new List<CarColorSave>();
        private List<int> _unlockedPaints = new List<int>();
        private HashSet<int> _paintCache = new HashSet<int>();
        private List<int> _unlockedEpicCars = new List<int>();
        ...
        public void RefreshPaintCache()
        {
            ...
            {
                _paintCache.Add(_unlockedPaints[i]);
            }
        }
